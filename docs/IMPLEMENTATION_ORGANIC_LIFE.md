...
### Acceptance Criteria
- [x] Сфера светится изнутри с циклом **2.5-3.8 сек** (отличается от дыхания 3.5-4.5 сек)
- [x] Частицы ближе к центру светятся **в 2-3 раза ярче** чем на поверхности
- [x] При смене фазы цвет свечения плавно меняется (transition 1-2 сек)
- [x] В BLEEDING фазе свечение пульсирует **заметно быстрее** (0.8-1.2 Hz)
- [x] В TRAUMA свечение становится **тусклым и редким**
- [x] Рассинхрон с дыханием **ощущается**, но не бросается в глаза
...
### Acceptance Criteria
- [x] Поверхность имеет **5-8 визуально различимых** зон разной чувствительности
- [x] При нажатии чувствительные зоны прогибаются на **40-60% больше** чем плотные
- [x] Зоны медленно дрейфуют — **полный цикл ~30-50 секунд**
- [x] Чувствительные участки имеют **тёплый оттенок** (визуально различимо)
- [x] Эффект **не бросается в глаза** при обычном просмотре, но заметен при внимательном изучении
- [x] Границы зон **размыты**, нет резких переходов
